    ...
    >
      <div className="flex items-center justify-between w-full max-w-6xl">
        ...
        <div className="flex-shrink-0">
          <img
            src={logo_full}
            alt="Pling Company - Agência de Tráfego Pago e Marketing Digital"
        ...
        {/* Desktop Navigation */}
        <nav
          className="hidden md:hidden xl:flex gap-8 xl:gap-10 items-center"
          role="navigation"
        ...
        {/* Desktop CTA Button */}
        <div className="hidden md:hidden xl:block flex-shrink-0">
          <Button
        ...
        {/* Mobile Menu Button */}
        <button
          className="xl:hidden md:block p-2 rounded-md hover:bg-gray-100 transition-colors duration-300"
      ...
      {isMenuOpen && (
        <div className="xl:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-100 z-50">
